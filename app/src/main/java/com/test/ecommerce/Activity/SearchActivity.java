...
import com.test.ecommerce.WordAdapter;
import com.test.ecommerce.databinding.ActivitySearchBinding;
...
public class SearchActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<String>(getWords(this).keySet());
        ...
        binding.editQuery.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (binding.editQuery.getText().toString().trim().length() == 1) {
                    ...
                    binding.editQuery.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_arrow_back, 0,
        ...
        binding.editQuery.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                    ...
                    System.out.println("ПРОВЕРКА Search Activity переход Result Activity в EditorActionListener");
        ...
        binding.editQuery.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (event.getRawX() >= (binding.editQuery.getRight() - binding.editQuery
                            .getCompoundDrawables()[DRAWABLE_RIGHT].getBounds().width())) {
                        // your action here
                        binding.editQuery.getText().clear();
                        return true;
                    }else if ((event.getRawX() + binding.editQuery.getPaddingLeft()) <= (
                            binding.editQuery.getCompoundDrawables()[DRAWABLE_LEFT].getBounds().width()
                                    + binding.editQuery.getLeft())) {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        System.out.println("ПРОВЕРКА Search Activity переход Result Activity ");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                System.out.println("ПРОВЕРКА Search Activity key word " + query);
            ...
            public boolean onQueryTextChange(String newText) {
                System.out.println("ПРОВЕРКА Search Activity key word " + newText);
